...
const techArray = [
    ...
    <TechStackElement key={`tech5-${Math.random()}`} icon={iconReact}>ReactJS</TechStackElement>,
    <TechStackElement key={`tech1-${Math.random()}`} icon={iconFigma}>Figma</TechStackElement>,
    <TechStackElement key={`tech5-${Math.random()}`} icon={iconNetlify}>Netlify & Vercel</TechStackElement>,
    <TechStackElement key={`tech5-${Math.random()}`} icon={iconLinux}>Linux, Windows & macOS</TechStackElement>,
];
