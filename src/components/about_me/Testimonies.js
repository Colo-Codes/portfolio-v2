...
const Testimonies = props => {
    return (
        <div class="flex flex-wrap gap-10 justify-evenly max-w-6xl mx-auto -mt-80 ">
            <CardTestimony image={reviewCesar} goTo='https://www.linkedin.com/in/damian-demasi-5451378/' personName='César Ariel Villagra' jobPosition={
                <>
            ...
            <CardTestimony image={reviewExequiel} goTo='https://www.linkedin.com/in/damian-demasi-5451378/' personName='Exequiel Barrirero' jobPosition={
                <>
                    <p>Co-Founder</p>
            ...
            <CardTestimony image={reviewAdrian} goTo='https://www.linkedin.com/in/damian-demasi-5451378/' personName='Adrián Dzienisik' jobPosition={
                <>
