        ...
        <div class='bg-black pb-32'>
            <section id='section-about'>
                ...
                <AboutMe projectTitle={`Hi! 👋 I'm Damian`} bgImage={'bg-virus'} techStack={['Figma', 'HTML5', 'CSS3', 'GitHub', 'JS']}>
                    ...
                    <ParagraphLight>
                        In 2019, my wife and I decided to quit our jobs, sell all of our possessions, and move to a different continent. We jumped over <a class='link link-primary' href='https://www.distancefromto.net/distance-from-argentina-to-australia' target='_blank' rel='noreferrer'>12.000 km</a> from Argentina to Australia, searching for new experiences and a better future. I landed in Australia and started studying for an MBA a couple of weeks later, which I finished in 2021.
                    </ParagraphLight>
                    <ParagraphLight>
